<template>
  <div>
    ...
    <p style="display: none">{{ (category = this.$route.params.category) }}</p>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
              <div class="job-listings">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-3 col-xs-12 text-center">
                    <span class="btn-open">{{ post.category }}</span>
                  </div>
                  <div class="col-lg-3 col-md-3 col-xs-12 text-center">
                    <button
                      class="btn btn-common"
                      @click="jobDetail(post.postid)"
                    >
                      Details
                    </button>
                  </div>
...
export default {
  ...
  methods: {
    loadPosts() {
      post.getPostsByCategory(this.category).then(res => {
        this.posts = res.data;
      });
    },
    jobDetail(postid) {
