        ...
        <div class="row justify-content-center">
          <div class="col-lg-9 col-md-12 col-xs-12">
            <div class="post-job box">
              ...
              <button class="btn btn-common log-btn mt-3" @click="savePost">
                Save
              </button>
            </div>
          </div>
...
import evaluator from "@/api/evaluator";
...
export default {
  ...
  watch: {
    postid() {
      evaluator.getEvaluatorsByPostid(this.postid).then(res => {
        this.evaluators = res.data;
      });
