...
public class ScoreServiceImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.recruit.recruitment.serviceImpl.ScoreServiceImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ScoreServiceImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.recruit.recruitment.serviceImpl.ScoreServiceImpl",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.recruit.recruitment.mapper.ScoreMapper", false, ScoreServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.recruit.recruitment.mapper.UserMapper", false, ScoreServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.recruit.recruitment.model.pojo.User", false, ScoreServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.recruit.recruitment.utils.JwtTokenUtil", false, ScoreServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, ScoreServiceImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ScoreServiceImpl_ESTest_scaffolding.class.getClassLoader()); 
