...
public class MailConfig_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.recruit.recruitment.config.MailConfig"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MailConfig_ESTest_scaffolding.class.getClassLoader() ,
      "com.recruit.recruitment.config.MailConfig"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MailConfig_ESTest_scaffolding.class.getClassLoader()); 
