...
public class UserServiceImpl implements UserDetailsService, UserService {
  ...
  @Override
  public void sendMail(String username, String mail) {
    User user = userMapper.selectByUsername(username);
    if (!user.getMail().equals(mail)) {
      throw new RuntimeException("The inconsistent mail address to the username");
    }
    ...
    rabbitTemplate.convertAndSend(RabbitMqConfig.MAIL_CODE_QUEUE, map);
  }
}
